	...
	/* デバッグ用 */
	{
		const HandTiles debugTile[Players] = {
			...
			},
			{
				...
				{NoTile,        Normal}, {NoTile, Normal}, {NoTile, Normal},
				{NoTile,        Normal}, {NoTile, Normal}, {NoTile, Normal},
				{NoTile,        Normal}, gameStat->Player[3].Hand[13],
			},
		};
		for (PlayerID i = 0; i < Players; ++i)
			memcpy(gameStat->Player[i].Hand, debugTile[i], sizeof (HandTiles));
	}
	{
		const MeldBuf debugTile[Players] = {
			{{},
				{CircleOne,   {Normal, Normal, Normal, Normal}, meldTripletExposedLeft},
				{CircleTwo,   {Normal, Normal, Normal, Normal}, meldTripletExposedLeft},
				{CircleThree, {Normal, Normal, Normal, Normal}, meldTripletExposedLeft},
				{CircleFour,  {Normal, Normal, Normal, Normal}, meldTripletExposedLeft},
			},
			{{},
				{CircleSix,   {Normal, Normal, Normal, Normal}, meldTripletExposedLeft},
				{CircleSeven, {Normal, Normal, Normal, Normal}, meldTripletExposedLeft},
				{CircleEight, {Normal, Normal, Normal, Normal}, meldTripletExposedLeft},
				{CircleNine,  {Normal, Normal, Normal, Normal}, meldTripletExposedLeft},
			},
			{{},
				{BambooOne,   {Normal, Normal, Normal, Normal}, meldTripletExposedLeft},
				{BambooTwo,   {Normal, Normal, Normal, Normal}, meldTripletExposedLeft},
				{BambooThree, {Normal, Normal, Normal, Normal}, meldTripletExposedLeft},
				{BambooFour,  {Normal, Normal, Normal, Normal}, meldTripletExposedLeft},
			},
			{{},
				{BambooSix,   {Normal, Normal, Normal, Normal}, meldTripletExposedLeft},
				{BambooSeven, {Normal, Normal, Normal, Normal}, meldTripletExposedLeft},
				{BambooEight, {Normal, Normal, Normal, Normal}, meldTripletExposedLeft},
				{BambooNine,  {Normal, Normal, Normal, Normal}, meldTripletExposedLeft},
			},
		};
		for (PlayerID i = 0; i < Players; ++i) {
			memcpy(gameStat->Player[i].Meld, debugTile[i], sizeof (MeldBuf));
			gameStat->Player[i].MeldPointer = 4;
			gameStat->Player[i].MenzenFlag = false;
		}
	}
#endif
	/* 摸打ループ */
