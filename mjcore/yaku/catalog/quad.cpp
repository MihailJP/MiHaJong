...
void yaku::yakuCalculator::YakuCatalog::catalogInit::yakulst_quad() {
	...
	yaku::yakuCalculator::YakuCatalog::Instantiate()->catalog.push_back(Yaku(
#ifdef GUOBIAO
		_T("四槓"), yaku::yakuCalculator::Yaku::yval_88,
		_T("\u78b0\u78b0和"),
#else /* GUOBIAO */
	...
	yaku::yakuCalculator::YakuCatalog::Instantiate()->catalog.push_back(Yaku(
#ifdef GUOBIAO
		_T("三槓"), yaku::yakuCalculator::Yaku::yval_32,
#else /* GUOBIAO */
	...
	/* 双暗槓 */
	yaku::yakuCalculator::YakuCatalog::Instantiate()->catalog.push_back(Yaku(
		_T("双暗槓"), yaku::yakuCalculator::Yaku::yval_8,
		[](const MENTSU_ANALYSIS* const analysis) -> bool {
	...
	/* 双明槓 */
	yaku::yakuCalculator::YakuCatalog::Instantiate()->catalog.push_back(Yaku(
		_T("双明槓"), yaku::yakuCalculator::Yaku::yval_4,
		[](const MENTSU_ANALYSIS* const analysis) -> bool {
			return (analysis->TotalKangzi == 2) && (analysis->TotalAnKangzi < 2);
		}
	));
	/* 暗槓 */
	yaku::yakuCalculator::YakuCatalog::Instantiate()->catalog.push_back(Yaku(
		_T("暗槓"), yaku::yakuCalculator::Yaku::yval_2,
		[](const MENTSU_ANALYSIS* const analysis) -> bool {
	...
	/* 明槓 */
	yaku::yakuCalculator::YakuCatalog::Instantiate()->catalog.push_back(Yaku(
		_T("明槓"), yaku::yakuCalculator::Yaku::yval_1,
		[](const MENTSU_ANALYSIS* const analysis) -> bool {
